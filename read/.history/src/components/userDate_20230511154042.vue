  ...
  <div class="page">
     <el-table
      ...
      >
        ...
        <el-table-column prop="wordGroup" label="词组1" width="100px">
        </el-table-column>
        <el-table-column prop="wordGroupMeaning" label="ci'z">
        </el-table-column>
        <el-table-column prop="wordGroup1" label="词组2" width="100px">
        </el-table-column>
