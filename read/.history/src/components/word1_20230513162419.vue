  ...
  <div class="page">
    ...
    >
      ...
      <span slot="footer" class="dialog-footer">
        <el-button type="primary" @click="<el-input type="textarea" v-model="" placeholder=""></el-input>"
          >确 定</el-button>
      </span>
    </el-dialog>
    <div class="mainbody">
...
export default {
  ...
  methods: {
    ...
    getSelectMeaning() {
      this.$axios
        ...
        .then((response) => {
          ...
          this.tableData[this.trueSelect].name = this.word.meaning;
    ...
    check() {
      if (this.select.name == this.word.meaning) {
        this.answer = true;
        this.$message({
          showClose: true,
          message: "恭喜你,回答正确",
