<template>
  <div class="page">
    ...
    <div class="essay_panel"> <span>{{show}}</span>
    <div><el-button  class="playbutton1" @click="playEspeech" >
        播放
      </el-button></div>
    ...
    <span>{{translate}}</span>
     ...
     <el-button class="playbutton2" @click="playEspeech1" >
        播放
      </el-button>
    </div>
