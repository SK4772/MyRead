...
export default {
  ...
  methods: {
    ...
    getSelectMeaning() {
      this.$axios
        ...
        .then((response) => {
          ...
          this.tableData[i].name = this.word.meaning;
        });
    },
    ...
    next() {
      ...
      console.log(123);
      this.getWortList();
      this.tableData[0].name = response.data[0];
      this.tableData[1].name = response.data[1];
      this.tableData[2].name = response.data[2];
      this.tableData[3].name = this.word.meaning;
