  ...
  data() {
    return {
      ...
      dataRule:{
        ...
        telephone:[
            { pattern: /^1(3[0-9]|5[0-3,5-9]|7[1-3,5-8]|8[0-9])\d{8}$/, message: '请输入正确的电话', trigger: 'blur' },
        ],
        mail:[
          { pattern: /^1(3[0-9]|5[0-3,5-9]|7[1-3,5-8]|8[0-9])\d{8}$/, message: '请输入正确的邮箱', trigger: 'blur' }
        ]
