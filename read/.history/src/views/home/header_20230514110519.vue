  ...
  <header>
    ...
    <el-form
      ...
      >
        ...
        <el-form-item label="密码" prop="essayid">
          <el-input v-model="dataForm.essayname" placeholder="" ></el-input>
        </el-form-item>
         <el-form-item label="昵称" prop="essayid">
          <el-input v-model="dataForm.essayid" placeholder="" ></el-input>
        </el-form-item>
        <el-form-item label="联系电话" prop="node">
          <el-input v-model="dataForm.node" placeholder=""></el-input>
        </el-form-item>
        <el-form-item label="联系邮箱" prop="node">
          <el-input v-model="dataForm.node" placeholder=""></el-input>
        </el-form-item>
