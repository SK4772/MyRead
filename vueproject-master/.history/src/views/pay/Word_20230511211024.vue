...
export default {
  ...
  methods: {
    getWordData() {
      console.log(123);
      this.$axios.post("/admin/word/query",{
        pageindex : this.pageparm
      }).then((response) => {
