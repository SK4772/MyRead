<template>
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      <el-form-item>
        <el-input v-model="wordInputContent" placeholder="参数名" clearable></el-input>
      </el-form-item>
      <el-form-item>
    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          ...
          <el-button type="text" size="small" @click="deleteHandle(scope.row.category_id,scope.row.componet)">
            删除
          </el-button>
        </template>
      </el-table-column>
...
export default {
  ...
  methods: {
    ...
    deleteHandle(id, name) {
      ...
      this.$confirm(`确定对 进行[${id ? '删除' : '批量删除'}]操作?`, '提示', {
