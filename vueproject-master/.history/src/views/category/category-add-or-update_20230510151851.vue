<template>
  <el-dialog
    ...
    <el-form-item label="类别名称" prop="category_name">
      <el-input v-model="dataForm.category_name" placeholder="请输入类别名称"></el-input>
    </el-form-item>
    </el-form>
    ...
    methods: {
      ...
      dataFormSubmit () {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            this.$axios.post("/api/admin/category/save",{
              'category_id': this.dataForm.category_id || undefined,
              'category_name': this.dataForm.category_name
            }).then((res) => {
